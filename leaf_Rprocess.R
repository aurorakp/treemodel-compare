...
bayesfiles <- lapply(1:6,function(i){paste("c:/seqgen/edgesandleaves/leaf",edgenum[i],"_bayes_toposummary.txt",sep="")})
raxmlfiles <- lapply(1:6,function(i){paste("c:/seqgen/edgesandleaves/leaf",edgenum[i],"_raxml_toposummary.txt",sep="")})
#beastfiles <- lapply(1:6,function(i){paste("c:/seqgen/edgesandleaves/leaf",edgenum[i],"_BEAST_toposummary.txt",sep="")})
phymlfiles <- lapply(1:6,function(i){paste("c:/seqgen/edgesandleaves/leaf",edgenum[i],"_phyml_toposummary.txt",sep="")})
...
bayesMatchOut <- paste("c:/seqgen/edgesandleaves/leaf_bayes_",topoPick,"_topomatches.txt",sep="")
raxmlMatchOut <- paste("c:/seqgen/edgesandleaves/leaf_raxml_",topoPick,"_topomatches.txt",sep="")
#beastMatchOut <- paste("c:/seqgen/edgesandleaves/leaf_beast_",topoPick,"_topomatches.txt",sep="")
phymlMatchOut <- paste("c:/seqgen/edgesandleaves/leaf_phyml_",topoPick,"_topomatches.txt",sep="")
